...
from agents import Agent, Runner, trace, function_tool, set_tracing_disabled, OpenAIChatCompletionsModel
...
def send_html_email(subject: str, html_body: str) -> Dict[str, str]:
    ...
    from_email = Email("asishpanachiyilmathew@gmail.com")  # Change to your verified sender
    to_email = To("asishpmathew@gmail.com")  # Change to your recipient
...
async def main():
    result = await asyncio.gather(
        Runner.run(sales_manager, message)
    )
    print(result)
